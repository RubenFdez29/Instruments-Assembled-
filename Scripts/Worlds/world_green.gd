...
#Función que se ejecuta cada vez que se carga la escena Pueblo verde.
# Carga el Jugador en sus coordenadas correspondientes y reproduce la música
# en bucle.
func _ready():
	$Travelers_home_duo.play()
	global.current_world = "green"
...
func _process(delta):
	...
	if Input.is_action_just_pressed("Pause"):
		$Travelers_home_duo.get_stream_paused()
...
#Activa la transición a la casa de la Trompeta monocromática y el sonido de 
# puerta al entrar en contacto con la colisión de la puerta.
func _on_trumpets_mono_house_transition_point_body_entered(body):
	if body.has_method("player"):
		global.transition_scene = true
...
func change_scene():
	if global.transition_scene == true:
		...
		if global.current_scene == "world_green" and scene_school_bol == true:
			get_tree().change_scene_to_file("res://Scenes/Houses/school.tscn")
			global.finish_changescenes("school")
		elif global.current_scene == "world_green" and scene_guitar_bol == true:
			get_tree().change_scene_to_file("res://Scenes/Houses/guitars_house.tscn")
			global.finish_changescenes("guitar_house")
		elif global.current_scene == "world_green" and scene_cello_bol == true:
			get_tree().change_scene_to_file("res://Scenes/Houses/cellos_house.tscn")
			global.finish_changescenes("cello_house")
		elif global.current_scene == "world_green" and scene_trumpet_bol == true:
			get_tree().change_scene_to_file("res://Scenes/Houses/trumpets_house_mono.tscn")
			global.finish_changescenes("trumpet_mono")
