...
#Función que se ejecuta al entrar en la casa de la Guitarra desde su mundo.
# Reproduce su música en bucle.
func _ready():
	$Guitars_travel.play()
	
	if global.first_time == true:
		DialogueManager.show_example_dialogue_balloon(load("res://Dialogues/Voices.dialogue"), "guitars_house")
...
func _process(delta):
	...
	if Input.is_action_just_pressed("Pause"):
		$Guitars_travel.get_stream_paused()
...
func change_scenes():
	if global.transition_scene == true:
		...
		if global.current_scene == "guitars_house" and global.current_world == "green":
			get_tree().change_scene_to_file("res://Scenes/Worlds/world_green.tscn")
			global.finish_changescenes("world_green")
		elif global.current_scene == "guitars_house" and global.current_world == "yellow":
			get_tree().change_scene_to_file("res://Scenes/Worlds/world_yellow.tscn")
			global.finish_changescenes("world_yellow")
		elif global.current_scene == "guitars_house" and global.current_world == "color":
